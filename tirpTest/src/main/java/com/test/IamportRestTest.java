...
public class IamportRestTest {
	...
	public static final String KEY = "아임포트 Rest Api key값을 넣으세요.";
	//"아임포트 Rest Api Secret로 설정"; 
	public static final String SECRET = "아임포트 Rest Api Secret값을 넣으세요.";  
	...
	public String pay(HttpServletRequest request, Model model) {
		...
		model.addAttribute("impKey", "아임포트의 가맹점 식별코드를 입력하세요."); 
		return "pay";
	}
