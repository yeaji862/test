...
$(document).ready(function(){
  ...
  <form action="planner_page.jsp">
  <div class="container px-1 px-sm-5 mx-auto">
 <h2 style="padding-left:18% ">인원수를 선택해주세요</h2>
      <br>
      <br>
      <br>
      <input type="number" class="form-control input1 input" name="start" style="width:150px; margin:0 auto; " value="0" >
        </div>
<div style="margin: auto; width:600px; position: absolute; bottom: 0px; padding-bottom:250px; transform : translate(-50%,0%); left:50%">
	<hr style="float:left; transition-property: width; transition-duration: 2s; width:66%">
	   <br>
	    <br>
